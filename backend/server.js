...
app.post("/api/products", requireAdmin, upload.fields([
  ...
  try {
    ...
    const newProduct = {
      ...
      launchPrice: req.body.launchPrice || "",
      useLaunchPrice: req.body.useLaunchPrice === "true",
      info: req.body.info,
...
app.put("/api/products/:id", requireAdmin, upload.fields([
  ...
  try {
    ...
    products[idx] = {
      ...
      launchPrice: req.body.launchPrice ?? existing.launchPrice,
      useLaunchPrice: req.body.useLaunchPrice !== undefined ? req.body.useLaunchPrice === "true" : existing.useLaunchPrice,
